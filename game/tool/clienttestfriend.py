...
#     WorldbossProto_pb2, NotifyProto_pb2, RelaxProto_pb2, FriendProto_pb2
#
# import servernames
# from game.proto import MailProto_pb2
# from game.util.excepts import IllegalStateError
#
# # _LOGIN_HOST = "192.168.1.135"
# # _LOGIN_HOST = "192.168.1.100"
# #_LOGIN_HOST = "120.26.245.189" # 斗鱼
# # _LOGIN_HOST = "121.41.58.161" # 153 登录服务器
# # _LOGIN_HOST = "120.26.56.18"
# _LOGIN_HOST = "127.0.0.1"
# _WORLD_HOST = "127.0.0.1"
# # _WORLD_HOST = "182.92.201.153"
# # _WORLD_HOST = "120.26.245.189"
# # _WORLD_HOST = "192.168.1.135"
...
#     logRes(cmd, response)
#
# def res_GetRoleInfoResponse(cmd, data):
#     response = FriendProto_pb2.GetRoleInfoResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
# def res_AddFriendResponse(cmd, data):
#     response = FriendProto_pb2.AddFriendResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
# def res_GetFriendListResponse(cmd, data):
#     response = FriendProto_pb2.GetFriendListResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
# def res_DelFriendResponse(cmd, data):
#     response = FriendProto_pb2.DelFriendResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
# def res_GetApplyForFriendListResponse(cmd, data):
#     response = FriendProto_pb2.GetApplyForFriendListResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
# def res_PassApplyForFriendResponse(cmd, data):
#     response = FriendProto_pb2.PassApplyForFriendResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
...
#     logRes(cmd, response)
#     print "--------------------<"
# def res_GetAddFriendListResponse(cmd, data):
#     response = FriendProto_pb2.GetAddFriendListResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
# def res_SearchFriendResponse(cmd, data):
#     response = FriendProto_pb2.SearchFriendResponse()
#     response.ParseFromString(data)
#     print "-------------------->"
#     logRes(cmd, response)
#     print "--------------------<"
...
#     # print "--------------------"
#
#     chq1Id = 763686283460477169
#     chq2Id = 763915613004370362
#
#     # request = FriendProto_pb2.GetRoleInfoRequest()
#     # request.id = chq2Id
#     # sendData(270, request, res_GetRoleInfoResponse)
#     #
#     request = FriendProto_pb2.AddFriendRequest()
#     request.id = chq2Id
#     sendData(271, request, res_AddFriendResponse)
#     #
#     # request = FriendProto_pb2.GetApplyForFriendListRequest()
#     # sendData(274, request, res_GetApplyForFriendListResponse)
#     #
#     # request = FriendProto_pb2.PassApplyForFriendRequest()
#     # request.id = chq1Id
#     # sendData(275, request, res_PassApplyForFriendResponse)
#     #
#     # request = FriendProto_pb2.GetFriendListRequest()
#     # sendData(272, request, res_GetFriendListResponse)
#     #
#     # request = FriendProto_pb2.DelFriendRequest()
#     # request.id = chq1Id
#     # sendData(273, request, res_DelFriendResponse)
#     #
#     # request = FriendProto_pb2.GetAddFriendListRequest()
#     # sendData(276, request, res_GetAddFriendListResponse)
#     #
#     # request = FriendProto_pb2.SearchFriendRequest()
#     # request.nameOrRoleId = str(chq1Id)
#     # #request.nameOrRoleId = str(chq1)
#     # sendData(277, request, res_SearchFriendResponse)
#
#     pass
#
#
